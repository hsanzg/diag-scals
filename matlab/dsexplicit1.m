function [P, x, y, residual, iter] = dsexplicit1(A, r, c, maxiter, tol)
%DSEXPLICIT1 Approximate diagonal scaling with prescribed row and column sums.
...
for iter=1:maxiter
    ...
    residual = norm([xmult; ymult.'] - 1, Inf);
